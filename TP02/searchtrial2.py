...
folder_path = "/Users/joshuahansvito/Documents/DDP 1/TP02/dataset" #Menyetel path dari folder data set
documents_count = 0 
    ...
    with open(file_full_path, "r") as opened_file:
        ...
        if len(sys.argv) == 3: # Program akan dijalankan ketika panjang list adalah 3
            if words_to_find in file_to_scan: # Ketika kata yang dicari ada di dalam file...
                ...
                # sys.stdout.write(f'\r{int(percentage)}%   ')
                # sys.stdout.flush()
...
print(f"Banyaknya dokumen yang ditemukan adalah {documents_count}") # Mencetak banyaknya file yang ditemukan
print(f"Waktu yang dibutuhkan adalah {total_time} detik") #Mencetak banyaknya waktu yang dibutuhkan 

# python3 searchtrial2.py all "barang bukti berupa 1 satu buah laptop"