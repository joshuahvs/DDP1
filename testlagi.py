...
lebar_batubata = int(numinput("Lebar batu bata", "Masukkan lebar batu bata", maxval=35))
tinggi_batubata = int(numinput("Tinggi batu bata", "Masukkan tinggi batu bata",minval=1, maxval=25))
tinggi_tower_pertama = int(numinput("Lapisan tower pertama", "Masukkan jumlah lapisan tower pertama", maxval=25))
lebar_badan_tower = int(numinput("Lebar badan tower", "Masukkan lebar badan tower", maxval=10))
