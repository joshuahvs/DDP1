...
while customer == True:
    ...
    if action == 1:
        ...
        food_first_line = first_line[18:].replace("\n", "")
        food_second_line = second_line[18:].replace("\n", "")
        ...
        for j in food_second_line:
            if j == ",":
                combine = food_second_line.find(",", index)
                food_checking = food_second_line[index:combine]
                print(food_checking)
                index = combine +1
